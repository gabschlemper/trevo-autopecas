...
export function Differential() {
  return (
    <section className="bg-terciary px-4 md:px-8 py-20 md:py-40 text-secondary flex flex-col gap-16">
      ...
      <div className="max-w-2xl py-10 shadow-lg p-6 rounded-xl">
        ...
        <p>
          ...
          oficina ou empresa do setor automotivo, estamos aqui para fornecer as
          peças e acessórios de que você precisa.
        </p>
        <span>
